    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6 py-12 max-w-6xl mx-auto">
          <img
            src="https://images.unsplash.com/photo-1596040033229-a9821ebd058d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c3BpY2VzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=2000&q=60"
            alt="key"
